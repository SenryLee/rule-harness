...
_GENRE_RULES: list[dict[str, Any]] = [
    ...
    {
        "genre": "裁判文书",
        "filename_kw": ("判决", "裁定", "裁判", "判例", "案例", "纠纷案", "抗诉", "再审", "民事判决", "仲裁裁决"),
        "body_kw": ("法院认为", "判决如下", "裁定如下", "本院认为", "原告", "被告", "上诉人", "被上诉人", "仲裁庭"),
        "weight": 5,
    },
    {
        "genre": "法律法规",
    ...
    {
        "genre": "监管与司法文件",
        "filename_kw": ("司法解释", "答记者问", "指引", "通知", "办法", "规定",
                        "证监会", "财政部", "国资委", "人民法院"),
    ...
    {
        "genre": "合同文本",
        "filename_kw": ("合同", "协议", "模板", "范本", "示范文本", "补充协议"),
    ...
    {
        "genre": "专业参考资料",
        "filename_kw": ("教程", "培训", "讲义", "论文", "报告", "研究", "书籍"),
        "body_kw": ("摘要", "参考文献", "关键词", "目录", "第一章"),
        "weight": 2,
    },
]
