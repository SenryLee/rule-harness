...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new?template=https://github.com/SenryLee/rule-harness)
...
点击上方 **Deploy on Railway** 按钮，登录后自动部署，约 2-3 分钟即可获得一个专属链接，分享给任何人直接使用。
